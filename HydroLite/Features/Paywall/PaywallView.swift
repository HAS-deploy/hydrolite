...
struct PaywallView: View {
    ...
    private var legalFooter: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text("HydroLite Premium (Monthly) — \(purchases.monthlyDisplayPrice) per month, auto-renewing subscription. Payment is charged to your Apple ID at confirmation of purchase and renews each month unless canceled at least 24 hours before the end of the current period. Manage or cancel in your Apple ID Account Settings.")
            Text("HydroLite Lifetime — \(purchases.lifetimeDisplayPrice) one-time non-consumable purchase. No recurring charges.")
